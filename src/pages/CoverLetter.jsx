    ...
    <motion.div {...pageTransition}>
      <div>
        ...
        <motion.div layout className="panel" style={{ lineHeight: "1.8" }}>
          ...
          <p>&nbsp;&nbsp;&nbsp;Thank you for the opportunity to apply. As you know, I was referred to the role by your colleague Lauren currently within GMHBA. She provided useful context around how the role differs from the public description. I understand that it is grounded in the digital delivery team and that I would be considered "on loan" for parts of the role. That insight made the position so much more interesting to me, particularly because I’m extremely adaptable between programming languages and frameworks. Most importantly I'm currently looking for hands-on development work in a team that focuses on practical delivery.</p>
